...
class TestResetPassword(TestCase):
    def setUp(self):
        ...
        user = User.objects.create_user(
            "Mell", "mell2010@gmail.com", "1234simplepassword"
        )
        self.response_post = self.client.post(
            reverse("password_reset"), {"email": "mell2010@gmail.com"}
        )
    ...
    def test_sending_email_to_reset_password(self):
        ...
        self.assertEqual(
            mail.outbox[0].subject, "Réinitialisation du mot de passe sur testserver"
        )
    ...
    def test_get_password_done(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertEqual(
            response.template_name, ["registration/password_reset_done.html"]
        )
