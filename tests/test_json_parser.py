...
def test_parser_json_telerama(xmltv_data):
    ...
    assert data["programmes"][0] == {
        ...
        "episode-num": "1.6.0/1",
        "public": 12,
        "titles": ["L'amie prodigieuse"],
        "directors": ["Saverio Costanzo"],
        "categories": ["Série", "Série dramatique", "Movie / Drama"],
        "actors": [
            {"actor": "Gaia Girace", "role": "Lila Cerullo"},
            {"actor": "Margherita Mazzucco", "role": "Elena Greco"},
            {"actor": "Giovanni Amura", "role": "Stefano Carracci"},
            {"actor": "Valentina Acca", "role": "Nunzia Cerullo"},
            {"actor": "Giorgia Gargano", "role": "Nadia Galiani"},
            {"actor": "Lia Zinno", "role": "Giuseppina Peluso"},
            {"actor": "Antonio Milo", "role": "Silvio Solara"},
            {"actor": "Christian Giroso", "role": "Antonio Cappuccio"},
        ],
        "writers": [
            "Elena Ferrante",
            "Francesco Piccolo",
    ...
    assert data["programmes"][2] == {
        ...
        "episode-num": "0.3.0/1",
        "public": 0,
        "titles": ["Trop cool, Scooby-Doo !", "Be Cool Scooby-Doo"],
        "directors": ["Shaunt Nigoghossian"],
        "categories": ["Jeunesse", "Dessin animé", "Children's / Youth programmes"],
        "actors": [],
        "writers": ["Joe Ballarini", "Marly Halpern-Graser", "Joe Ruby", "Ken Spears"],
        "composers": [],
        "countries": ["américain"],
    }
